# Motor de inferencia en Python
 ...
 ## Objetivos:
 ### Se utilizo este motor de inferencia para determinar el funcionamiento de un sistema de diagnostico y se implemento nuevas caratersticas en el codigo python para mejor la experiencia y funcionamiento.


## Descripcion de nuevas caracteristicas:
